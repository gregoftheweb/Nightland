...
export const reducer = (state = initialState, action) => {
    switch (action.type) {
        case 'MOVE_PLAYER':
            return { ...state, player: { ...state.player, position: action.payload.position } };
        case 'MOVE_MONSTER':
            return {
                ...state,
                activeMonsters: state.activeMonsters.map(monster =>
                    monster.id === action.payload.id ? { ...monster, position: action.payload.position } : monster
                )
            };
        ...
        case 'SPAWN_MONSTER':
            return { ...state, activeMonsters: [...state.activeMonsters, action.payload.monster] };
        case 'SET_COMBAT':
            return {
                ...state,
        ...
        case 'MOVE_REDOUBT':
            return { ...state, redoubt: { ...state.redoubt, position: action.payload.position } };
        default:
