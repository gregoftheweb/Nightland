...
// Combat messages
export const combatVictoryPlayerComment = "You emerged victorious!";
export const combatVictoryEnemyComment = "The enemy stands triumphant!";
export const combatDeathPlayerComment = "He overwhelmed you!";
export const combatDeathEnemyComment = "You vanquished him!";
export const combatPlayerHitComment = "You hit for 6 points!";
export const combatPlayerMissComment = "You swing and miss!";
export const combatEnemyHitComment = "He hit you for 4 points!";
export const combatEnemyMissComment = "He swings and misses!";
